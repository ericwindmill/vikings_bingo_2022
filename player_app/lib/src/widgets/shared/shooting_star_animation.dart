...
/// Shows a ShootingStart (celebratory) animation: paper snippings falling down.
///
...
class ShootingStartPainter extends CustomPainter {
...
class _ShootingStarsState extends State<ShootingStars>
  ...
  @override
  void didUpdateWidget(covariant ShootingStars oldWidget) {
...
class _Star {
  ...
  final double size = 2 + _random.nextDouble();
